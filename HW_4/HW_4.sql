...
alter authorization on database::[HomeWork1] to [sa]
...
( 
	...
	FILENAME = 'D:\HomeWork1.ldf',      -- Указываем Физическое полное имя файла журнала БД.
...
2)Вынести столбцы Name, Post, Info и History в отдельные таблицы 	
...
( 
	...
	FILENAME = 'D:\HomeWork4 .ldf',      -- Указываем Физическое полное имя файла журнала БД.
	SIZE = 5MB,                        -- Задаем начальный размер файла журнала БД.
