...
--********************************************************************************
/*Рассмотрите схему базы данных AdventureWorks2014, найдите 4 взаимосвязанные таблицы.*/
...
( 
	...
	FILENAME = 'D:\MyJoinsDB.ldf',      -- Указываем Физическое полное имя файла журнала БД.
